              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Bloglar</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Kategoriler</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Yayınlanan</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php?s=publish">
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                      Görüntüle
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Taslaklar</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php?s=draft">
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                      Görüntüle
...
<footer class="footer footer-inverse">
      <div class="container">
        <div class="text-center">
          <small>Yönetici Paneli | Proje <a href="https://github.com/kaplanark/blog">GitHub</a></small>
        </div>
      </div>
    </footer>
  </body>
