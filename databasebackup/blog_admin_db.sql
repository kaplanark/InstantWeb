...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 01 May 2021, 13:59:00
...
--
-- Veritabanı: `blog_admin_db`
--

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `banner_posts`
--
...
--
-- Tablo döküm verisi `banner_posts`
--
...
--
-- Tablo için tablo yapısı `editors_choice`
--
...
--
-- Tablo döküm verisi `editors_choice`
--
...
(1, 'titles', '1', 'admin', 1524766759, 1619870249, 2),
...
(18, 'blog_categories', '7', 'admin', 1619869426, 1619869426, 2);
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@mail.com', '2018-04-26', 2, 0, 1, NULL, NULL, NULL, NULL, 'Admin member created automatically on 2018-04-26\nRecord updated automatically on 2018-04-27', NULL, NULL),
('guest', NULL, NULL, '2018-04-26', 1, 0, 1, NULL, NULL, NULL, NULL, 'Anonymous member created automatically on 2018-04-26', NULL, NULL);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `page_hits`
--
...
(1, 'İnstantWeb', 'Page', '92848300_1619868929.png', 'blog,tech blog,tricks,hacks,technology news,fantastic blog', 'Bu bir blog ve içerik yönetim sistemidir, blogunuzu kolaylıkla kurabilir ve ihtiyaçlarınıza göre özelleştirebilirsiniz.Bu blogunuzun kısa bir açıklamasıdır.', 'Yeni fikirler bulun <span> düşünün</span>', 'Fikirlerinizi yazın<span>vakit kaybetmeyin</span>', 'İnsanlarla paylaşın <span>yorumları alın</span>', 'Yorumları değerlendirin <span>kendinizi geliştirin</span>', 'Bu bir blog ve içerik yönetim sistemidir, Blogunuzu kolayca kurabilir ve ihtiyaçlarınıza göre özelleştirebilirsiniz.Kullanımı ve yönetimi kolaydır.Çok sayıda kullanıcı kayıt olabilir ve içeriğe katkıda bulunabilir.', 'Turkey,Turkey', 'info@mail.com', '0708344101', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100949.24429313939!2d-122.44206553967531!3d37.75102885910819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `visitor_info`
--
...
--
-- Tablo döküm verisi `visitor_info`
--
...
--
-- Tablo için indeksler `banner_posts`
--
...
--
-- Tablo için indeksler `editors_choice`
--
...
--
-- Tablo için indeksler `membership_grouppermissions`
--
ALTER TABLE `membership_grouppermissions`
  ADD PRIMARY KEY (`permissionID`);

--
-- Tablo için indeksler `membership_groups`
--
ALTER TABLE `membership_groups`
  ADD PRIMARY KEY (`groupID`);

--
-- Tablo için indeksler `membership_userpermissions`
--
ALTER TABLE `membership_userpermissions`
  ADD PRIMARY KEY (`permissionID`);

--
-- Tablo için indeksler `membership_userrecords`
--
...
--
-- Tablo için indeksler `membership_users`
--
...
--
-- Tablo için indeksler `page_hits`
--
...
--
-- Tablo için indeksler `visitor_info`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `banner_posts`
--
ALTER TABLE `banner_posts`
...
--
-- Tablo için AUTO_INCREMENT değeri `editors_choice`
--
ALTER TABLE `editors_choice`
...
--
-- Tablo için AUTO_INCREMENT değeri `membership_grouppermissions`
--
ALTER TABLE `membership_grouppermissions`
  MODIFY `permissionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- Tablo için AUTO_INCREMENT değeri `membership_groups`
--
ALTER TABLE `membership_groups`
  MODIFY `groupID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- Tablo için AUTO_INCREMENT değeri `membership_userpermissions`
--
ALTER TABLE `membership_userpermissions`
  MODIFY `permissionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `membership_userrecords`
--
ALTER TABLE `membership_userrecords`
...
--
-- Tablo için AUTO_INCREMENT değeri `visitor_info`
--
ALTER TABLE `visitor_info`
