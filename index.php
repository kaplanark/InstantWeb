...
<body>
	...
	<?php include("header.php");?> <!--devam etmeden önce header-->
	<?php include("banner.php");?> <!--devam etmeden önce banner-->
			...
			<div class="row">
				...
				<aside class="col-lg-4 agileits-w3ls-right-blog-con text-right">
					<div class="right-blog-info text-left">
						<h4><strong>Kategoriler</strong></h4> <!--kategoriler sayfası-->
